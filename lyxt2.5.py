...
def load_users():
    ...
    if os.path.exists(users_file):
        ...
        admin_info = {'username': 'admin', 'password': '123456', 'is_admin': True, 'messages': [], 'inbox': [], 'is_banned': False, 'ban_end_time': None}
...
def register(users):
    ...
    uid = str(uuid.uuid4())
    users[uid] = {'username': username, 'password': password, 'is_admin': False, 'messages': [], 'inbox': [], 'is_banned': False, 'ban_end_time': None}
    save_users(users)
